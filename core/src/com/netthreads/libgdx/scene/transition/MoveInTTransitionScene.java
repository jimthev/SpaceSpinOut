...
/**
 * Transition: Move in from top.
 */
public class MoveInTTransitionScene extends TransitionScene {
    private static Pool<MoveInTTransitionScene> _pool = new Pool<MoveInTTransitionScene>() {
        @Override
        protected MoveInTTransitionScene newObject() {
            MoveInTTransitionScene transitionScene = new MoveInTTransitionScene();
     ...
     */
    public static MoveInTTransitionScene $(Scene inScene, Scene outScene, int durationMillis, TweenEquation easeEquation) {
        MoveInTTransitionScene transitionScene = _pool.obtain();
