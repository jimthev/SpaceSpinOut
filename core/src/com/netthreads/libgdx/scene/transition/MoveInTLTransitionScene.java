 ...
 */
public class MoveInTLTransitionScene extends TransitionScene {
    private static Pool<MoveInTLTransitionScene> _pool = new Pool<MoveInTLTransitionScene>() {
        @Override
        protected MoveInTLTransitionScene newObject() {
            MoveInTLTransitionScene transitionScene = new MoveInTLTransitionScene();
     ...
     */
    public static MoveInTLTransitionScene $(Scene inScene, Scene outScene, int durationMillis, TweenEquation easeEquation) {
        MoveInTLTransitionScene transitionScene = _pool.obtain();
