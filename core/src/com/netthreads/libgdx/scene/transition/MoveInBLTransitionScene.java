 ...
 */
public class MoveInBLTransitionScene extends TransitionScene {
    private static Pool<MoveInBLTransitionScene> _pool = new Pool<MoveInBLTransitionScene>() {
        @Override
        protected MoveInBLTransitionScene newObject() {
            MoveInBLTransitionScene transitionScene = new MoveInBLTransitionScene();
     ...
     */
    public static MoveInBLTransitionScene $(Scene inScene, Scene outScene, int durationMillis, TweenEquation easeEquation) {
        MoveInBLTransitionScene transitionScene = _pool.obtain();
