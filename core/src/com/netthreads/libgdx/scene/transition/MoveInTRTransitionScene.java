 ...
 */
public class MoveInTRTransitionScene extends TransitionScene {
    private static Pool<MoveInTRTransitionScene> _pool = new Pool<MoveInTRTransitionScene>() {
        @Override
        protected MoveInTRTransitionScene newObject() {
            MoveInTRTransitionScene transitionScene = new MoveInTRTransitionScene();
     ...
     */
    public static MoveInTRTransitionScene $(Scene inScene, Scene outScene, int durationMillis, TweenEquation easeEquation) {
        MoveInTRTransitionScene transitionScene = _pool.obtain();
