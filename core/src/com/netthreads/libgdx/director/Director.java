 ...
 * Scene director.
 * <p/>
 * This class routes actor events around observers and updates the view. It also
 * maintains global note of view width and height.
 */
...
public class Director implements Disposable {
    ...
    public void setWidthHeight(int width, int height) {
        ...
        if (scene != null) {
            scene.getViewport().setScreenSize(width, height);
...
//			scene.setViewport(width, height, stretch);
    ...
    @Override
    public void dispose() {
        // System.out.println("director.dispose");
        // dumpStackTrace();
        spriteBatch.dispose();
    }
