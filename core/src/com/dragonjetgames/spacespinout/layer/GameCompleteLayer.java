...
public class GameCompleteLayer extends Layer {
    ...
    public GameCompleteLayer(float width, float height) {
        setWidth(width);
        setHeight(height);
    ...
    private void buildElements() {
        // Title
        titleLabelA = new Label("You have succesfully", skin, URL_LABEL_FONT, Color.YELLOW);
        titleLabelA.setFontScale(magnificationScale);
        titleLabelB = new Label("SpunOut!", skin, URL_LABEL_FONT, Color.YELLOW);
